...
// ADMIN //
const Admin = lazy(() => import("../../DashboardPages/Admin"));
const Auth = lazy(() => import("../../DashboardPages/Auth"));
// ...
///////////
        ...
        fallback={
          <div className="loader-container">
            <div className="loader-container-inner">
              ...
              <h6 className="mt-5">
                Please wait while we load all the Admin pages
                <small>
        ...
        fallback={
          <div className="loader-container">
            <div className="loader-container-inner">
              ...
              <h6 className="mt-5">
                Please wait while we load all the Auth pages
                <small>
                  Because this is a demonstration we load at once all the
                  Components examples. This wouldn't happen in a real live app!
                </small>
