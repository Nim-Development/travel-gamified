...
trait Put
{
    ...
    {
        $res = $this->json('PUT', 'api/games/multiple_choice/-1');
        $res->assertStatus(404);
    }
    ...
    public function can_add_a_header_image_to_end_of_media_collection_from_game_multiple_choice()
    {
        ...
        $old_game = $this->create('Games\GameMultipleChoice', $old_values);
        ...
        // When
        $res = $this->json('PUT','api/games/multiple_choice/'.$old_game->id, $files);
    ...
    public function can_update_game_multiple_choice_fully_on_each_model_attribute()
    {
        ...
        // When
        $response = $this->json('PUT','api/games/multiple_choice/'.$old_game->id, $new_values);
    ...
    public function can_update_game_multiple_choice_on_a_couple_of_model_attributes()
    {
        ...
        $old_game = $this->create('Games\GameMultipleChoice', array_merge($old_values_to_be_updated, $old_values_to_remain_after_update));
    ...
    public function can_add_options_to_the_end_of_relational_options()
    {
        ...
        // create 3 options and link them to $game
        $this->create_collection('Games\GameMultipleChoiceOption', ['game_id' => $old_game->id], false, 2);
        ...
        // When
        $res = $this->json('PUT','api/games/multiple_choice/'.$old_game->id, $options);
